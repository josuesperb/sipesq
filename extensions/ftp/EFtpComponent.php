...
class EFtpComponent extends CApplicationComponent
{
	...
	public function download($dir=null){
		$ftpsite = "ftp://grsevero:gorder@143.54.64.51";
		header('Location: ftp://grsevero:gorder@143.54.64.51');
	}
...
public function directory_exists($dir) 
	{
		 if($this->getActive()){
		    ...
		    $origin = ftp_pwd($this->_connection); 
		    
		    // Attempt to change directory, suppress errors 
		    if (@ftp_chdir($this->_connection, $dir)) 
		    { 
		        // If the directory exists, set back to origin 
		        ftp_chdir($this->_connection, $origin);    
		        return true; 
		    } 
