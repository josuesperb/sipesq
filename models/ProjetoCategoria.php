...
/**
 * This is the model class for table "projeto_categoria".
 *
 * The followings are the available columns in table 'projeto_categoria':
...
class ProjetoCategoria extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'projetos' => array(self::HAS_MANY, 'Projeto', 'cod_categoria'),
		);
	}
