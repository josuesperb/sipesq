...
class Subscription extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('descricao, preco, login, senha, link, validade, titulo', 'safe'),
			array('descricao, link, titulo', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, descricao, preco, login, senha, link, validade, titulo', 'safe', 'on'=>'search'),
		);
	}
