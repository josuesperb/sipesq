...
class LinksController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				'actions'=>array('index','view','search','redirect'),
				'users'=>array('*'),
			),
	 ...
	 * @param string $link o link a ser redirecionado
	 */
...
public function actionSearch($q=null)
	{	
		...
		$criteria->addSearchCondition('t.tags', $model->nome,true,'OR','ILIKE');
		$criteria->addSearchCondition('t.descricao', $model->nome,true,'OR','ILIKE');
		$criteria->addSearchCondition('t.link', $model->nome,true,'OR','ILIKE');
//		
